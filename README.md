...
<img src="logo.png" width="160" alt="Anubis" />
...
<img src="https://img.shields.io/badge/C-A8B9CC?style=flat-square&logo=c&logoColor=111" alt="C" />
...
Full stack developer. Backend, frontend, infra, the whole thing.

Private work: bots, clients, dashboards, APIs, and internal tools. Whatever the job needs.

## What I do

| Area | |
| :--- | :--- |
| **Full Stack** | Apps from database to UI |
| **Backend** | APIs, workers, services |
| **Frontend** | Dashboards, web apps, UI |
| **DevOps** | Linux, Docker, CI, cloud |
...
- Full stack tools and private services
- Backend in Go / Node / Python
- Frontend in React / Next / TypeScript
- Infra on Linux + Docker
